...
<head runat="server">
    ...
    <title>Free ASP .NET Timeline Example BY BINARY THEME</title>
    <!-- Bootstrap core CSS -->
    ...
    <!-- Timeline -->
    <link href="App_Themes/css/timeline.css" rel="stylesheet" />
     <!-- custom CSS here -->
...
<body>
   ...
   <!--Core JavaScript file  -->
    <script src="App_Themes/js/jquery-1.10.2.js"></script>
